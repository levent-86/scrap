...
<p align="center">
  ...
  ·
  <a href="https://github.com/levent-86/scrap/issues">Request a New Feature</a>
</p>
...
<p align="center">
  The <strong>NeuraLetter Suite: Scrap</strong> extension is available on the Chrome Web Store.
  <br />
...
<ul>
  <li>
    <strong>Quick-Capture Keyboard Shortcuts (The Ultimate Speed Boost):</strong>
    <ul>
      <li>Stop the copy-paste routine completely. Now, after selecting text on a website, simply press a corresponding number key (e.g., <kbd>1</kbd> for 'Company Name') on your keyboard.</li>
      <li>The selected text is automatically pasted into the correct field in the side panel.</li>
      <li>This feature virtually eliminates the need to manually CTRL+C - CTRL+V, allowing you to capture data with unparalleled speed and maintain complete focus on the website content.</li>
    </ul>
  </li>
  <li>
  ...
  <li>
    <strong>A Focused Workspace (The Persistent Side Panel):</strong>
    <ul>
  ...
  <li>
    ...
    <ul>
      ...
      <li>Your data is instantly stored, AND the extension automatically closes the current tab.</li>
...
<h2 align="center">Contributing & Development</h2>

<p align="center">
  Interested in contributing or setting up a local development environment?
  <br />
  For details on the project's Technology Stack, Local Setup Instructions, and Coding Standards, please refer to our comprehensive 
  <a href="./CONTRIBUTE.md"><strong>Developer Guide & Contribution Guidelines</strong></a>.
</p>
